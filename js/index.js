...
var padding = 15;
var textTop = 'I want to make a meme';
var textMiddle = 'Uncomfortable penguin'
var textBottom = 'but the EU blocked memes';
var textSizeTop = 10;
var textSizeMiddle = 4;
...
function draw() {
  ...
  ctx.drawBreakingText(top, canvas.width/2, _textSizeTop+padding, null, 1, 'stroke');
	...
	// draw middle text
	style('Arial', _textSizeMiddle, 'center', 'center');
	ctx.fillStyle = '#000';
	ctx.strokeStyle = '#fff';
